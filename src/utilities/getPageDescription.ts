...
export function getQuestionDescription(q: any): string {
	if (q) return q.data.description ? truncateDescription(q.data.description) : truncateDescription(getFirstSentence(removeMd(q.body)))
	return ''
}
